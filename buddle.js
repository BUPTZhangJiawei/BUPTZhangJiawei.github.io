...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": function() { return /* binding */ GameControl; }\n/* harmony export */ });\n/* harmony import */ var _Food__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Food */ \"./src/modules/Food.ts\");\n/* harmony import */ var _ScorePanel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ScorePanel */ \"./src/modules/ScorePanel.ts\");\n/* harmony import */ var _Snake__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Snake */ \"./src/modules/Snake.ts\");\n\n\n\nclass GameControl {\n  constructor() {\n    this.direction = \"Right\";\n    this.initSpeed = 300;\n    this.speedStep = 25;\n    this.isLive = true;\n    this.isPause = false;\n    this.keydownHandler = event => {\n      if (event.key === \"p\") {\n        this.pauseHandler();\n        return;\n      }\n      if ([\"ArrowUp\", \"ArrowDown\", \"ArrowLeft\", \"ArrowRight\", \"Up\", \"Down\", \"Left\", \"Right\"].includes(event.key)) {\n        this.direction = event.key;\n      }\n    };\n    this.pauseHandler = () => {\n      this.isPause = !this.isPause;\n    };\n    this.upHandler = () => {\n      this.direction = \"Up\";\n    };\n    this.downHandler = () => {\n      this.direction = \"Down\";\n    };\n    this.leftHandler = () => {\n      this.direction = \"Left\";\n    };\n    this.rightHandler = () => {\n      this.direction = \"Right\";\n    };\n    this.run = () => {\n      if (!this.isPause) {\n        let X = this.snake.X;\n        let Y = this.snake.Y;\n        switch (this.direction) {\n          case 'ArrowUp':\n          case 'Up':\n            {\n              Y -= 10;\n              break;\n            }\n          case 'ArrowDown':\n          case 'Down':\n            {\n              Y += 10;\n              break;\n            }\n          case 'ArrowLeft':\n          case 'Left':\n            {\n              X -= 10;\n              break;\n            }\n          case 'ArrowRight':\n          case 'Right':\n            {\n              X += 10;\n              break;\n            }\n          default:\n            ;\n        }\n        this.checkEat(X, Y);\n        try {\n          this.snake.X = X;\n          this.snake.Y = Y;\n        } catch (e) {\n          this.isLive = false;\n          if (confirm(e.message + \", Game Over\\n点击确定重新开始，点击取消保留页面\")) {\n            location.reload();\n          }\n        }\n      }\n      this.isLive && setTimeout(this.run, this.initSpeed - (this.scorePanel.level - 1) * this.speedStep);\n    };\n    this.snake = new _Snake__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\n    this.food = new _Food__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\n    this.scorePanel = new _ScorePanel__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\n    document.addEventListener(\"keydown\", this.keydownHandler);\n    document.getElementById(\"up\").addEventListener('touch', this.upHandler);\n    document.getElementById(\"up\").addEventListener('mousedown', this.upHandler);\n    document.getElementById(\"down\").addEventListener('touch', this.downHandler);\n    document.getElementById(\"down\").addEventListener('mousedown', this.downHandler);\n    document.getElementById(\"left\").addEventListener('touch', this.leftHandler);\n    document.getElementById(\"left\").addEventListener('mousedown', this.leftHandler);\n    document.getElementById(\"right\").addEventListener('touch', this.rightHandler);\n    document.getElementById(\"right\").addEventListener('mousedown', this.rightHandler);\n    document.getElementById(\"pause-button\").addEventListener('touch', this.pauseHandler);\n    document.getElementById(\"pause-button\").addEventListener('mousedown', this.pauseHandler);\n    this.init();\n  }\n  init() {\n    this.run();\n  }\n  checkEat(x, y) {\n    if (x === this.food.X && y === this.food.Y) {\n      this.food.change();\n      this.scorePanel.addScore();\n      this.snake.addBody();\n    }\n  }\n}\n\n//# sourceURL=webpack://ts_study/./src/modules/GameControl.ts?");
...
eval("\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://ts_study/./node_modules/css-loader/dist/runtime/noSourceMaps.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://ts_study/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://ts_study/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://ts_study/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
